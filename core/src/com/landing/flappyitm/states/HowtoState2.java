...
public class HowtoState2 extends State{
    ...
    private static final int TEXT2Y = 321;
    ...
    public HowtoState2(GameStateManager gsm){
        super(gsm);
        ...
        bg = new Texture ("Background_How_To_#2.png");
    }
    ...
    public void render(SpriteBatch spriteBatch) {
        ...
        GlyphLayout textLayout1 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyHowto2_1), Color.WHITE, AnchoTexto, Align.left, true);
        GlyphLayout textLayout2 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyHowto2_2), Color.WHITE, AnchoTexto2, Align.left, true);
