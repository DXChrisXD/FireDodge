...
public class HowtoState3 extends State{
    ...
    private static final int TEXT2X = 240;

    private static final int TEXT1Y = 557;

    private static final int TEXT2Y = 336;
    ...
    public HowtoState3(GameStateManager gsm){
        super(gsm);
        ...
        bg = new Texture ("Background_How_To_#3.png");
    }
    ...
    public void render(SpriteBatch spriteBatch) {
        ...
        GlyphLayout textLayout1 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyHowto3_1), Color.WHITE, AnchoTexto, Align.left, true);
        GlyphLayout textLayout2 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyHowto3_2), Color.WHITE, AnchoTexto2, Align.left, true);
