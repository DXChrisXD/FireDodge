...
public class LanguageState extends State{
    ...
    private static final int TEXT1X = 344;

    private static final int TEXT1Y = 522;

    private static final int TEXT2Y = 347;
    ...
    public void render(SpriteBatch spriteBatch) {
        ...
        GlyphLayout titleLayout = new GlyphLayout(scoreFont, d.getValue(Dictionary.Keys.KeyLanguage), Color.WHITE, 0, Align.left, false);
        GlyphLayout textLayout1 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyLanguage1_1), Color.WHITE, AnchoTexto, Align.left, true);
        GlyphLayout textLayout2 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyLanguage1_2), Color.WHITE, AnchoTexto, Align.left, true);
