...
public class StoryState3 extends State{
    ...
    private static final int TEXT2X = 224;

    private static final int TEXT1Y = 550;

    private static final int TEXT2Y = 422;
    ...
    public StoryState3(GameStateManager gsm){
        super(gsm);
    ...
    public void render(SpriteBatch spriteBatch) {
        ...
        GlyphLayout textLayout1 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyStory3_1), Color.WHITE, AnchoTexto, Align.left, true);
        GlyphLayout textLayout2 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyStory3_2), Color.WHITE, AnchoTexto2, Align.left, true);
