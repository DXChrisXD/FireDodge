...
public class StoryState2 extends State{
    ...
    private static final int TEXT2Y = 375;
    ...
    public StoryState2(GameStateManager gsm){
        super(gsm);
    ...
    public void render(SpriteBatch spriteBatch) {
        ...
        GlyphLayout textLayout1 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyStory2_1), Color.WHITE, AnchoTexto, Align.left, true);
        GlyphLayout textLayout2 = new GlyphLayout(scoreFont2, d.getValue(Dictionary.Keys.KeyStory2_2), Color.WHITE, AnchoTexto, Align.left, true);
